        ...
        static void render(nlohmann::json::object_t const &element) {
            ...
            static const std::unordered_map<std::string_view, std::function<void(nlohmann::json::object_t const &)>> renderers {
                ...
                {"text", [](nlohmann::json::object_t const &el){ 
                    ImGui::SameLine();
                    ImGui::TextUnformatted(el.at("text").get<std::string_view>().data()); }},
                ...
                {"codeBlock", [](nlohmann::json::object_t const &el) {
                    auto const language = el.at("attrs").at("language").get<std::string_view>();
                    auto const text = el.at("content").at(0).at("text").get<std::string_view>();
                ...
                {"inlineExtension", [](nlohmann::json::object_t const &el) {
                    auto const extension = el.at("attrs").at("extensionType").get<std::string_view>();
                    auto const text = el.at("content").at(0).at("text").get<std::string_view>();
                    ImGui::Text("%s", text.data());
                }},
                {"inlineCard", [](nlohmann::json::object_t const &el) {
                    auto const title = el.at("attrs").at("title").get<std::string_view>();
                    auto const text = el.at("content").at(0).at("text").get<std::string_view>();
                    ImGui::Text("%s", text.data());
                }},
                ...
                {"mention", [](nlohmann::json::object_t const &el) {
                    auto const text = el.at("attrs").at("text").get<std::string_view>();
                    ImGui::Text("%s", text.data());
                }},
            ...
            auto const type = element.at("type").get<std::string_view>();
